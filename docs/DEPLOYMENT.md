...
- `GEMINI_LEARNER_MODEL=gemini-2.0-flash`
- `GEMINI_CHAIN_MODEL=gemini-2.0-flash`
- `GEMINI_PROMPT_EVOLVER_MODEL=gemini-2.0-flash`
- `GEMINI_CHAIN_ENABLED=true`
- `GEMINI_TAGGER_TIMEOUT_MS=15000`
...
- `GEMINI_DECISION_MODEL=gemini-2.0-flash`
